    ...
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      <main className="mx-auto flex min-h-screen max-w-3xl flex-col px-6 py-10">
        ...
        <section className="space-y-6 text-sm leading-relaxed text-gray-700">
          ...
          <p>
            분석·문진·체크인 응답은 화장품 관리 보조를 위한 자기보고 정보이며,
            의료 진단·치료 효과를 단정하지 않습니다. 체크인 일정(3·7·15·30일)과
            루틴 기록은 서비스 개선·재방문 관리에 사용될 수 있으며, 이메일
            알림은 수신 동의가 있을 때만 발송을 시도합니다(현재 운영 환경에
            따라 dry-run일 수 있음).
          </p>
          <p>
            사진 업로드는 선택 사항이며, 안전하게 구현·고지되기 전까지 필수로
            요구하지 않습니다. 얼굴·건강 정보를 외부 AI로 자동 전송하지 않는
            것을 원칙으로 합니다(분석 API에 사용하는 텍스트 입력은 별도 서버
            설정을 따름).
          </p>
          ...
          <p>
            ...
            보장할 수는 없습니다. 삭제·열람 요청은 아래 연락처로 가능합니다.
          </p>
