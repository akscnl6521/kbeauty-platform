...
import { DiscoveryImportClient } from "../DiscoveryImportClient";

export const dynamic = "force-dynamic";
export const metadata = {
  title: "Admin Discovery Import | K-Beauty Match",
  robots: { index: false, follow: false },
};

/**
 * URL / CSV quick discovery import page.
 */
export default async function AdminDiscoveryImportPage() {
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              제품 URL을 붙여넣으면 정보를 추출하고 중복을 확인한 뒤 후보로
              등록합니다. 가격·재고는 참고만 하며 offer로 저장되지 않습니다.
            </p>
