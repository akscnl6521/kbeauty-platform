...
const PRODUCT_PATH =
  /\/products?\/|\/product\/|\/goods\/|\/item\/|\/shopdetail|branduid=|[?&]product[_-]?id=|\/product_detail|\/goods_view|_prd_view\.do|_goods_view\.do|_item_view\.do|[?&](i_sproductcd|productcd|prdcd|goodsno|itemno)=/i;
