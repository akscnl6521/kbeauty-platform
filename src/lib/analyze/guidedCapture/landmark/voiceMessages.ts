...
const STATUS_MSG: Record<CaptureVoiceLocale, Partial<Record<string, string>>> = {
  ...
  en: {
    ...
    no_face: "Face not found. Move into the guide.",
    multiple_faces: "Only one face should be visible.",
    move_left: "Center your face left–right.",
    move_right: "Center your face left–right.",
    move_up: "Move your face a little higher.",
    move_down: "Move your face a little lower.",
    move_closer: "Come a little closer.",
    move_farther: "Move the phone a little farther away.",
