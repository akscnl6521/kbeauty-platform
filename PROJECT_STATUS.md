...
- 기준 브랜치: `main`
- 최근 main 병합: PR #27
- 최근 main 커밋: `bd8b70fcbe7ac9af6ae3eb9512d99ae0157c0540`
...
- 단계 3 제품 데이터 자동화와 관리자 통합 검수 화면은 코드·CI 기준 완료
- 제품 사용 영상의 권리·게시 가능성·사용법 선택 정책은 기반 구현 완료
- 다음은 제품·루틴·부위 화면 연결과 권리 만료 검수 큐 구현

## 다음 작업

1. 제품 사용 가이드를 제품·루틴·부위 화면에 연결
2. 영상 권리 만료·삭제·비공개 점검 큐 구현
3. 관리자 영상 검수 화면 구현
4. AI 생성·광고·협찬 표시 정책 보강
5. Preview 로그인 후 관리자 통합 검수 화면 육안 확인
